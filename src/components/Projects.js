    ...
    return (
        ...
        <div className="card">
          <div className="card-body img1">
            <h4 className="card-title"><strong>Weather Dashboard</strong></h4>
            ...
            <a href="" className="expbtn btn-primary" target="_blank" rel="noopener noreferrer">GitHub</a>
          </div>
        </div>
      </div>
      <div className="col-sm-6">
        <div className="card">
          <div className="card-body img2">
            <h4 className="card-title"><strong>Note Taker</strong></h4>
        ...
        <div className="col-sm-6">
          <div className="card">
            <div className="card-body img3">
              <h4 className="card-title"><strong>Password Generator</strong></h4>
        ...
        <div className="card justify-content-center">
          <div className="card-body img4">
            <h4 className="card-title"><strong>Workday Scheduler</strong></h4>
      ...
      <div className="col-sm-6">
        <div className="card justify-content-center">
          <div className="card-body img5">
            <h4 className="card-title"><strong>Employee Tracker</strong></h4>
        ...
        <div className="card justify-content-center">
          <div className="card-body img6">
            <h4 className="card-title"><strong>BuddyGram</strong></h4>
